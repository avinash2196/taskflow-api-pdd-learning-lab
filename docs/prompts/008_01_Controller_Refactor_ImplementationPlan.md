...
Task : Read Plan.md,004_Implementation_Plan_Controller_Test.md,005_Implementation_Plan_Controller.md and create an 008_Implementation_Plan_Controller_Refactor.md file.
...
- Make sure common codes if exists in controller test and controller , then refactor it in common method .Create Helper files if needed.
...
Created 008_Implementation_Plan_Controller_Refactor.md for review._